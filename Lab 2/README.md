...
**Theme: PiClock that reminds me of the relativity of time**

Time is a relative concept. It can be measured differently, and it can be expressed and perceived differently. 
While the main page shows the time of HERE & NOW, 
...
Lastly, sometimes the numerical representation of time doesn't really matter.
Our body signals us that it's time to eat! 
For those moments, I added a menu suggestion function activated by pressing both buttons at the same time. 
(because I usually take 30mins+ to choose the menu. This clock not only shows the time but also SAVES my time.)


https://user-images.githubusercontent.com/42717070/134107330-884276bc-faa6-45d0-b1db-9591101b67cf.MOV


https://drive.google.com/drive/folders/1Uc-AdIcnrvvMKdUj9tW_fb4nQhS0lo3O?usp=sharing

## Part G. 
## Sketch and brainstorm further interactions and features you would like for your clock for Part 2.


I can add a function to start a timer from ZERO activated by some actions, to gain control of the flowing time. 
